...
/* build-hook-start *//*00001*/try { require('c:\\users\\fredy\\.vscode\\extensions\\wallabyjs.console-ninja-0.0.198\\out\\buildhook\\index.js').default({tool: 'nuxt'}); } catch(cjsError) { try { import('file:///c:/users/fredy/.vscode/extensions/wallabyjs.console-ninja-0.0.198/out/buildhook/index.js').then(m => m.default.default({tool: 'nuxt'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
...
import { a as showVersions, s as showBanner } from '../shared/nuxi.91c97a93.mjs';
