<template id="filters" >
  <div class="col-12 mt-xl-7 mt-lg-1 mb-10 d-none d-lg-block filt position-sticky filters scroll">
    <div class="row">
      <div class="col">
        <!--begin::Accordion-->
        <div class="accordion" id="kt_accordion_1">
          ...
          <div class="accordion-item" >
            <h2 class="accordion-header" id="kt_accordion_1_header_2">
              <button
                class="accordion-button "
                :class="paramsQuery.brand == '' && paramsQuery.model == '' && 'collapsed'"
                type="button"
                data-bs-toggle="collapse"
            ...
            <div
              ...
              class="accordion-collapse collapse"
              :class="(paramsQuery.brand != '' || paramsQuery.model != '') && 'show'"
              aria-labelledby="kt_accordion_1_header_2"
            >
              <div class="accordion-body  border-0">        
                <div class="row">
                  <div class="col-12" v-for="brand in searchedBrands" :key="brand.id">
                    <!--begin::Accordion-->
                    <div class="accordion" :id="'kt_accordion_' + brand.name">
                      <div class="accordion-item border-0">
                        ...
                        >
                          <button
                            ...
                            :class="
                              paramsQuery.brand.includes(brand.name) && 'is-active'
                            "
                            type="button"
                            data-bs-toggle="collapse"
                            :data-bs-target="'#kt_accordion_1_body_1' + brand.name"
                            aria-expanded="true"
                            :aria-controls="'#kt_accordion_1_body_1' + brand.name"
                          > 
                            <img :src="`img/brand/${brand.name}.svg`"  class="brand-logo"/>
                            <span class="filters__text fw-normal">{{ brand.name }}</span>
                          </button>
                        </h2>
                        <div
                          ...
                          :class="
                            paramsQuery.brand.includes(brand.name) ? 'show' : 'collapse'
                          "
                          :aria-labelledby="'kt_accordion_header' + brand.name"
                        >
                          <div class="accordion-body border-0 ">
                            <div class="btn-model">
                              <div
                              ...
                              >
                                <button
                                  @click="applyFilter('model', model.name, 'push')"
                                  class="btn btn-filters py-1 px-4"
                                  :class="paramsQuery.model.includes(model.name) && 'is-active'"
                                >
                                  <span class="filters__text fw-normal" >{{ model.name }}</span>
                                </button>
                              </div>
                            </div>
                          </div>
              ...
              <div class="accordion-body border-0 ">
                ...
                <div v-for="tipo in searchedTypes" :key="tipo">
                  <button
                    ...
                    :class="paramsQuery.type.includes(tipo.name) && 'is-active'"
                    class="btn btn-filters me-3 w-100 my-2 py-2 px-3 text-start"
                  >
                    
                    <span class="filters__text fw-normal">{{ tipo.name }}</span>
                  </button>
                </div>
              </div>
            </div>
          ...
          <div class="accordion-item" >
            ...
            <div
              ...
              class="accordion-collapse collapse"
              :class="(paramsQuery.state != '' && paramsQuery.agency == '') && 'show'"
              ...
              <div class="accordion-body border-0 ">
                ...
                <div v-for="state in searchedStates" :key="state">
                  <button
                    ...
                    :class="paramsQuery.state.includes(state.name) && 'is-active'"
                    class="btn btn-filters me-3 w-100 my-2 py-2 px-3 text-start"
                  >
                    <span class="filters__text fw-normal">{{ state.name }}</span>
                  </button>
                </div>
              </div>
            </div>
          ...
          <div class="accordion-item" >
            ...
            <div
              ...
              class="accordion-collapse collapse"
              :class="(paramsQuery.city != '' && paramsQuery.agency == '') && 'show'"
              ...
              <div class="accordion-body border-0 ">
                ...
                <div v-for="city in searchedCities" :key="city">
                  <button
                    ...
                    :class="paramsQuery.city.includes(city.name) && 'is-active'"
                    class="btn btn-filters me-3 w-100 my-2 py-2 px-3 text-start"
                  >
                    <span class="filters__text fw-normal">{{city.name }}</span>
                  </button>
                </div>
              </div>
            </div>
          ...
          <div class="accordion-item" >
            ...
            >
              <div class="accordion-body border-0 ">
                ...
                <div v-for="transmission in searchedTransmitions" :key="transmission">
                  <button
                    @click="applyFilter('transmission', transmission.name, 'push')"
                    :class="paramsQuery.transmission.includes(transmission.name) && 'is-active'"
                    class="btn btn-filters me-3 w-100 my-2 py-2 px-3 text-start"
                  >
                    <span class="filters__text fw-normal">{{transmission.name }}</span>
                  </button>
                </div>
              </div>
            </div>
              ...
              <div class="accordion-body border-0 ">
                ...
                <div v-for="fuel in searchedTypesFuel" :key="fuel">
                  <button
                    ...
                    :class="paramsQuery.fuel.includes(fuel.name) && 'is-active'"
                    class="btn btn-filters me-3 w-100 my-2 py-2 px-3 text-start"
                  >
                    <span class="filters__text fw-normal">{{fuel.name }}</span>
                  </button>
                </div>
              </div>
            </div>
              ...
              <div class="accordion-body border-0 ">
                ...
                <div v-for="colorex in searchedColorExt" :key="colorex">
                  <button
                    ...
                    :class="paramsQuery.colorex.includes(colorex.name) && 'is-active'"
                    class="btn btn-filters me-3 w-100 my-2 py-2 px-3 text-start"
                  >
                    <span class="filters__text fw-normal">{{colorex.name }}</span>
                  </button>
                </div>
              </div>
            </div>
              ...
              <div class="accordion-body border-0 ">
                ...
                <div v-for="colorin in searchedColorInt" :key="colorin">
                  <button
                    ...
                    :class="paramsQuery.colorin.includes(colorin.name) && 'is-active'"
                    class="btn btn-filters me-3 w-100 my-2 py-2 px-3 text-start"
                  >
                    <span class="filters__text fw-normal">{{colorin.name }}</span>
                  </button>
                </div>
              </div>
            </div>
              ...
              <div class="accordion-body border-0 ">
                ...
                <div v-for="agencies in searchedAgenciesInt" :key="agencies">
                  <button
                    ...
                    :class="paramsQuery.agency.includes(agencies.name) && 'is-active'"
                    class="btn btn-filters me-3 w-100 my-2 py-2 px-3 text-start"
                  >
                    <span class="filters__text fw-normal">{{agencies.name }}</span>
                  </button>
                </div>
              </div>
            </div>
          ...
          <div class="accordion-item" >
            ...
            >
              <div class="accordion-body border-0 ">
                <Range v-if="searchPrice[0] !== 0 || searchPrice[1] !== 0"
                      :valMin="searchPrice[0]"
                      :valMax="searchPrice[1]"
                      :type="'price'"
          ...
          <div class="accordion-item" >
            ...
            >
              <div class="accordion-body border-0 ">
                <Range v-if="searchKms[0] !== 0 || searchKms[1] !== 0"
                      :valMin="searchKms[0]"
                      :valMax="searchKms[1]"
                      :type="'kms'"
                      @searchRange="handleSearchRange"
  ...
  <div class=" d-lg-none catalogo__deck">
    ...
    >
      ...
      alt="">
      <div class="catalogo__deck-box">
        <span class="catalogo__deck-filter-text">Filtros</span>
        <span class="catalogo__deck-filter-text">(1)</span>
      </div>
    </div>
    <div class="catalogo__deck-btn">
      <img 
    ...
    >
      ...
      <div class="modal-content">
        <div class="modal-header py-3 px-5">
          <button type="button" data-bs-dismiss="modal" class="fs-5 fw-bold btn-go">  Regresar
          </button>
          <div
        ...
        <div class="modal-body px-5 py-3">
          ...
          <!--end::Accordion-->
          <button data-bs-dismiss="modal" class="btn btn-primary w-100 mt-6 button-modal">
...
export default {
  ...
  setup(props, { emit }) {
    ...
    const handleSearchRange = (rangeMin, rangeMax, type) => {
      if (type == "price") {
      const priceMin = (rangeMin == null ? props.prop_prices[0] : rangeMin);
      const priceMax = (rangeMax == null ? props.prop_prices[1] : rangeMax)
      priceValue.value = [priceMin, priceMax];
      applyFilter("price", priceValue.value.toString(), "range");
      }
      if (type == "kms") {
      const kmsMin = (rangeMin == null ? props.prop_kms[0] : rangeMin);
      const kmsMax = (rangeMax == null ? props.prop_kms[1] : rangeMax)
      kmsValue.value = [kmsMin, kmsMax];
