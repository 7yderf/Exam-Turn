<template>
  <div class="banners-m__main">
    <div class="banners-m__prewiev">

      <h2 class="banners-m__title">Previsualización</h2>

      <div class="banners-m__carrusel-box" v-for="(value, key, index) in formValues" :key="index"
        :data-active="value.flag === active">
        <div class="banners-m__box-media">
          <div class="banners-m__box-play" v-if="typeVideo == 'Video'">
            <img :src="Play" alt="" class="banners-m__box-play-im">
          </div>
        ...
        <div class="banners-m__carrusel-background" :data-update="Boolean(value.id)"
          v-if="value.where == 'slider' && value.flag == active && typeVideo == 'Image'">
          <img :src="Background" alt="">
          <p class="banners-m__carrusel-back-text">
            Arrastra o
            <span class="banners-m__carrusel-back-span">
        ...
        <div class="banners-m__box-tex-banners">
          <h2 class="banners-m__box-title">{{ value.flag === active && value.where === 'slider' ? titles :
              formValues['home_1'].title
          }}</h2>
          <p class="banners-m__box-text">{{ value.flag === active && value.where === 'slider' ? texts :
      ...
      <div class="banners-m__opcions-active">
        <button v-for="(value, key, index) in formValues" :key="index" :data-active="value.where === 'slider'"
          class="banners-m__opcion-btn-active" @click="bannerActive(value.flag)">
          {{ index + 1 }}
        </button>
      </div>

      <div class="banners-m__home2">
        <div v-for="(value, key, index) in formValues" :key="index" class="banners-m__home2-box"
          :data-active="value.where === 'home2'">
          <div class="banners-m__home2-active-box" v-if="value.flag !== active" @click="bannerActive(value.flag)">
          </div>
          <div class="banners-m__home2-box-drop" v-if="value.where === 'home2'">
            <img :src="value.banner" alt="" class="banners-m__home2-img-back">
            <div class="banners-m__home2-drop">
              <Drop :type="value.flag" :active="active" :fileData="fileData" @changeAddFile="onFileAdd"
                @changeRemoveFile="onFileRemove" />
            </div>
            <button class="banners-m__home2-btn-active" @click="bannerActive(value.flag)">
              <img :src="icon_edit" alt="" />
            </button>
          </div>

        </div>
        <div class="banners-m__home2-box" :data-active="true">

          <p class="banners-m__home2-copy-1">Compra un auto certificado</p>
          <p class="banners-m__home2-copy-2">Revisa nuestros planes de financiamiento</p>

        </div>
      </div>

      <div class="banners-m__added">
        <p class="banners-m__added-title">Recientemente agregados</p>
        <div class="banners-m__added-box" v-for="mock in Array(2)
        .fill('')
        .map((_, i) => i)" :key="mock">
          <div class="banners-m__added-box-img">
            <img :src="imgArray[1]" alt="">
          </div>
          <div class="banners-m__added-box-text">
            <p class="banners-m__added-text">Vehículo</p>
          </div>
        </div>
      </div>
      ...
      <div class="banners-m__home2">
        <div v-for="(value, key, index) in formValues" :key="index" class="banners-m__home2-box"
          ...
          <div class="banners-m__home2-box-drop" v-if="value.where === 'home3'">
            <img :src="value.banner" alt="" class="banners-m__home2-img-back">
            <div class="banners-m__home2-drop">
              <Drop :type="value.flag" :active="active" :fileData="fileData" @changeAddFile="onFileAdd"
                @changeRemoveFile="onFileRemove" />
        ...
        <div class="banners-m__home2-box banners-m__home2-box--dark" :data-active="true">

          <p class="banners-m__home2-copy-1 banners-m__home2-copy-1--dark">Compra un auto certificado</p>
          <p class="banners-m__home2-copy-2 banners-m__home2-copy-2--dark">Revisa nuestros planes de financiamiento</p>

        </div>
      </div>

      <div class="banners-m__added banners-m__added--shell">
        <p class="banners-m__added-title banners-m__added-title--shell">Recientemente agregados</p>
        <div class="banners-m__added-box banners-m__added-box--shell" v-for="(mock, index) in Array(2)
        .fill('')
        .map((_, i) => i)" :key="mock">
          <div class="banners-m__added-box-img banners-m__added-box-img--shell">
            <img :src="imgArray[index]" alt="">
          </div>
        </div>
      </div>

      <div class="banners-m__added banners-m__added--delivery">
        <p class="banners-m__added-title banners-m__added-title--delivery">Tú decides la entrega</p>
        <div class="banners-m__added-box banners-m__added-box--delivery" v-for="mock in Array(1)
        .fill('')
        .map((_, i) => i)" :key="mock">
          <div class="banners-m__added-box-img banners-m__added-box-img--delivery">
            <img :src="imgArray[3]" alt="">
          </div>
          <div class="banners-m__added-box-text banners-m__added-box-text--delivery">
            <p class="banners-m__added-text banners-m__added-text--delivery">Vehículo</p>
          </div>
        </div>
      </div>
    ...
    <div class="banners-m__form-box">
      <h2 class="banners-m__title banners-m__title--form">Opciones</h2>
      <div class="banners-m__subtitle-content">
        <p class="banners-m__subtitle">Selecciona un banner</p>
        <button v-show="show" class="banners-m__subtitle" @click="showForm">
          <img :src="Close" alt="" class="banners-m__btn-set">
        </button>
      </div>

      <div class="banners-m__form-stycky" v-show="show" v-if="refreshData">
...
import "@/assets/styles/views/Banners-m.scss";
    ...
    watch(
      ...
      (val) => {
        ...
        setTimeout(() => {
          ...
          titles.value = formValues.value[val].title;
          texts.value = formValues.value[val].description;
    ...
    async function getData() {
      ...
      Object.keys(formValues.value).map((element, index) => {
        formValues.value[`home_${index + 1}`] = {
          ...
          mobil: data.data.mobil[index] ? data.data.mobil[index].mobil : '1',
          banner: data.data.mobil[index] ? data.data.mobil[index].banner : '',
          where: data.data.mobil[index] ? data.data.mobil[index].where : formValues.value[`home_${index + 1}`].where,
          flag: `home_${index + 1}`,
