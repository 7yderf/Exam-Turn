<template>
  <div class="userDetalle__main">
    <div class="userDetalle__prewiev">
      ...
      <div class="userDetalle__box-detail">
        <div class="userDetalle__detail"><img :src="imgArray[1]" alt=""></div>
        <div class="userDetalle__deatil-text-box">
      ...
      <div class="userDetalle__box-desc">
      ...
      <div class="userDetalle__home2">
        ...
        <div class="userDetalle__home2-box" :data-active="true">
          ...
          <div class="userDetalle__added">
            <p class="userDetalle__added-title">Recientemente agregados</p>
            <div class="userDetalle__added-box" v-for="mock in Array(3)
            .fill('')
            .map((_, i) => i)" :key="mock">
...
export default {
  ...
  setup() {
    ...
    // https://apivanguardia.demosturn.com/api/banners/detail
    
    async function getData() {
      const response = await fetch('https://apivanguardia.demosturn.com/api/banners/detail', {
        method: 'GET',
        headers: {
