<template>
  <main class="banners">
    ...
    <article class="banners__body">
      ...
      <BannersConfig v-if="device === 'desktop'" />
      <BannersConfigMobile v-else />
...
import BannersConfig from "@/views/client/components/dasboard/BannersConfig.vue";
import BannersConfigMobile from "@/views/client/components/dasboard/BannersConfigMobile.vue";
