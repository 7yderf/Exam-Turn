  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _cssVars = { style: {
        "--2cee700e": unref(iconUrl)
      } };
      _push(`<span${ssrRenderAttrs(mergeProps({
        style: { width: unref(sSize), height: unref(sSize) }
      }, _attrs, _cssVars))} data-v-7b1dd9dc></span>`);
    };
  }
});
...
const IconCSS = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-7b1dd9dc"]]);

export { IconCSS as default };
//# sourceMappingURL=IconCSS-9ff3c6bb.mjs.map
