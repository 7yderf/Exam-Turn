import { u as useNuxtApp, g as useState } from './server.mjs';
...
import { u as useAppConfig } from './config-3191beeb.mjs';
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      if (unref(isFetching)) {
        ...
        }, _attrs))} data-v-b7dd3a21>${ssrInterpolate(__props.name)}</span>`);
      }
    };
  }
});
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-b7dd3a21"]]);

export { __nuxt_component_0 as default };
//# sourceMappingURL=Icon-941ecd1a.mjs.map
